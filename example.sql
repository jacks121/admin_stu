...
-- Exported by joe at 04-07-2023 00:35.
...
-- Inserting 4 rows into backend_access_log
-- Insert batch #1
...
(4, 1, '127.0.0.1', '2023-07-03 14:50:55', '2023-07-03 14:50:55');
...
-- Inserting 4 rows into backend_user_preferences
-- Insert batch #1
...
(4, 1, 'cadon_stunring', 'product', 'lists', '{"visible":["id","product_name","image_url","category_name","sku","original_price","current_price","on_sale","video_url","sales","created_at","updated_at"],"order":["id","product_name","image_url","category_name","sku","original_price","current_price","on_sale","description","video_url","sales","created_at","updated_at"],"per_page":"20"}', NULL, NULL);
...
(1, 'joe', 'j', 'admin', 'jacks12@qq.com', '$2y$10$Ak7P7o3nVUOgRnBgyUjBb.zxVOBtu1P1AgTitdT7YhRzKKBa5AWuq', NULL, '$2y$10$iwS68wJ49BH8Raui4XA/M.v.2Vxr6ys6X5UrWwlYqu24.d301sGRC', NULL, '', 1, 1, NULL, '2023-07-03 14:50:55', NULL, 1, '2023-06-29 13:07:04', '2023-07-03 14:50:55');
...
-- BEGIN TABLE cadon_stunring_advertisement_items
DROP TABLE IF EXISTS cadon_stunring_advertisement_items;
CREATE TABLE `cadon_stunring_advertisement_items` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `advertisement_images` json DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Inserting 6 rows into cadon_stunring_advertisement_items
-- Insert batch #1
INSERT INTO cadon_stunring_advertisement_items (id, advertisement_id, link, sort, created_at, updated_at, deleted_at, advertisement_images) VALUES
(1, 1, 'http://example.com/link1', 1, '2023-07-03 15:25:23', '2023-07-03 16:32:42', NULL, '["/284725477_10223201818608621_2801487919247514155_n.jpg"]'),
(2, 1, 'http://example.com/link2', 2, '2023-07-03 15:25:23', '2023-07-03 16:32:33', NULL, '["/2530537-8.jpg"]'),
(3, 1, 'http://example.com/link3', 3, '2023-07-03 15:25:23', '2023-07-03 16:32:26', NULL, '["/2530537-5.jpg"]'),
(4, 2, 'http://example.com/link4', 1, '2023-07-03 15:25:23', '2023-07-03 15:25:23', NULL, NULL),
(5, 2, 'http://example.com/link5', 2, '2023-07-03 15:25:23', '2023-07-03 15:25:23', NULL, NULL),
(6, 2, 'http://example.com/link6', 3, '2023-07-03 15:25:23', '2023-07-03 15:25:23', NULL, NULL);

-- END TABLE cadon_stunring_advertisement_items
...
CREATE TABLE `cadon_stunring_product_attributes` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品属性表';

-- Inserting 30 rows into cadon_stunring_product_attributes
-- Insert batch #1
...
(11, 5, 3, 11, 123, '2023-06-04 13:11:49', '2023-07-03 16:22:35', NULL),
(12, 5, 3, 12, 321, '2023-06-04 13:11:49', '2023-07-03 16:22:35', NULL),
(14, 5, 3, 14, 333, '2023-06-04 13:11:49', '2023-07-03 16:22:35', NULL),
(15, 5, 3, 15, 111, '2023-06-04 13:11:49', '2023-07-03 16:22:35', NULL),
(16, 5, 4, 16, 100, '2023-06-04 13:11:49', '2023-07-03 16:22:35', NULL),
(17, 5, 4, 17, -50, '2023-06-04 13:11:49', '2023-07-03 16:22:35', NULL),
(18, 5, 4, 18, -100, '2023-06-04 13:11:49', '2023-07-03 16:22:35', NULL),
(19, 5, 4, 19, -50, '2023-06-04 13:11:49', '2023-07-03 16:22:35', NULL),
(20, 5, 4, 20, -50, '2023-06-04 13:11:49', '2023-07-03 16:22:35', NULL),
...
(41, 10, 0, 0, NULL, '2023-07-03 16:20:10', '2023-07-03 16:20:10', NULL);
...
(5, 'Product 24343', 'SKU-5', 110, 2, 1, 'This is product 2', 'http://product2.video', 98, '2023-05-12 14:05:26', '2023-07-03 16:22:35', NULL, '{"Size": "17", "Metal": "Pseudo Gold", "Width": "13.5mm", "Weight": "23g", "Rhodium": "Yes", "Stone Cut": "Round", "Thickness": "2.5mm", "Stone Size": "1.0*1.0mm", "Stone Type": "Lab Created gemstone", "Stone Color": "White", "Carat Weight": "0.02CT/pcs", "Plating Color": "Rosegold/Platinum"}', '["/2230522-2.jpg"]'),
...
CREATE TABLE `cadon_stunring_reviews` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='评价表';

-- Inserting 13 rows into cadon_stunring_reviews
-- Insert batch #1
...
(19, 10, 1, 5, 'fdsafdsafdsa', '2023-07-04 16:21:09', '2023-07-03 16:21:10', NULL, '["/2230529--1.jpg"]');
...
-- Inserting 15 rows into deferred_bindings
-- Insert batch #1
...
(19, 'Cadon\\Stunring\\Models\\Product', 'product_attributes', 'Cadon\\Stunring\\Models\\ProductAttribute', 41, NULL, '23kNmtqNHjf3PSl0DaeSLSSnXAaL1HXteVO6bdQn', 1, '2023-07-03 16:20:10', '2023-07-03 16:20:10');
...
-- Inserting 15 rows into system_event_logs
-- Insert batch #1
...
(6, 'error', 'Exception: Unexpected type of array when attempting to save attribute "product_images", try adding it to the $jsonable property. in /Users/joe/Documents/www/admin/vendor/october/rain/src/Database/Model.php:395\nStack trace:\n#0 /Users/joe/Documents/www/admin/vendor/october/rain/src/Database/Model.php(444): October\\Rain\\Database\\Model->saveInternal(Array)\n#1 /Users/joe/Documents/www/admin/modules/backend/traits/FormModelSaver.php(38): October\\Rain\\Database\\Model->save(Array)\n#2 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Database/Concerns/ManagesTransactions.php(30): Backend\\Behaviors\\FormController->Backend\\Traits\\{closure}(Object(October\\Rain\\Database\\Connections\\MySqlConnection))\n#3 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Database/DatabaseManager.php(469): Illuminate\\Database\\Connection->transaction(Object(Closure))\n#4 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Support/Facades/Facade.php(338): Illuminate\\Database\\DatabaseManager->__call(''transaction'', Array)\n#5 /Users/joe/Documents/www/admin/modules/backend/traits/FormModelSaver.php(35): Illuminate\\Support\\Facades\\Facade::__callStatic(''transaction'', Array)\n#6 /Users/joe/Documents/www/admin/modules/backend/behaviors/FormController.php(326): Backend\\Behaviors\\FormController->performSaveOnModel(Object(Cadon\\Stunring\\Models\\Advertisement), Array, Array)\n#7 [internal function]: Backend\\Behaviors\\FormController->update_onSave(''2'', NULL)\n#8 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/ExtendableTrait.php(506): call_user_func_array(Array, Array)\n#9 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/Extendable.php(46): October\\Rain\\Extension\\Extendable->extendableCall(''update_onSave'', Array)\n#10 /Users/joe/Documents/www/admin/modules/system/traits/DependencyMaker.php(29): October\\Rain\\Extension\\Extendable->__call(''update_onSave'', Array)\n#11 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(598): Backend\\Classes\\Controller->makeCallMethod(Object(Cadon\\Stunring\\Controllers\\Advertisement), ''update_onSave'', Array)\n#12 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(448): Backend\\Classes\\Controller->runAjaxHandler(''onSave'')\n#13 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(256): Backend\\Classes\\Controller->execAjaxHandlers()\n#14 /Users/joe/Documents/www/admin/modules/backend/classes/BackendController.php(118): Backend\\Classes\\Controller->run(''update'', Array)\n#15 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Controller.php(54): Backend\\Classes\\BackendController->run(''cadon/stunring/...'')\n#16 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/ControllerDispatcher.php(43): Illuminate\\Routing\\Controller->callAction(''run'', Array)\n#17 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(259): Illuminate\\Routing\\ControllerDispatcher->dispatch(Object(Illuminate\\Routing\\Route), Object(Backend\\Classes\\BackendController), ''run'')\n#18 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(205): Illuminate\\Routing\\Route->runController()\n#19 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(798): Illuminate\\Routing\\Route->run()\n#20 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Routing\\Router->Illuminate\\Routing\\{closure}(Object(Illuminate\\Http\\Request))\n#21 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Middleware/SubstituteBindings.php(50): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#22 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Routing\\Middleware\\SubstituteBindings->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#23 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/View/Middleware/ShareErrorsFromSession.php(49): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#24 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\View\\Middleware\\ShareErrorsFromSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#25 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(121): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#26 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(64): Illuminate\\Session\\Middleware\\StartSession->handleStatefulRequest(Object(Illuminate\\Http\\Request), Object(Illuminate\\Session\\Store), Object(Closure))\n#27 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Session\\Middleware\\StartSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#28 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/AddQueuedCookiesToResponse.php(37): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#29 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\AddQueuedCookiesToResponse->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#30 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/EncryptCookies.php(67): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#31 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\EncryptCookies->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#32 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#33 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(797): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#34 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(776): Illuminate\\Routing\\Router->runRouteWithinStack(Object(Illuminate\\Routing\\Route), Object(Illuminate\\Http\\Request))\n#35 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(740): Illuminate\\Routing\\Router->runRoute(Object(Illuminate\\Http\\Request), Object(Illuminate\\Routing\\Route))\n#36 /Users/joe/Documents/www/admin/vendor/october/rain/src/Router/CoreRouter.php(32): Illuminate\\Routing\\Router->dispatchToRoute(Object(Illuminate\\Http\\Request))\n#37 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(190): October\\Rain\\Router\\CoreRouter->dispatch(Object(Illuminate\\Http\\Request))\n#38 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Foundation\\Http\\Kernel->Illuminate\\Foundation\\Http\\{closure}(Object(Illuminate\\Http\\Request))\n#39 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Middleware/PreventRequestsDuringMaintenance.php(86): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#40 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/Http/Middleware/CheckForMaintenanceMode.php(23): Illuminate\\Foundation\\Http\\Middleware\\PreventRequestsDuringMaintenance->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#41 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): October\\Rain\\Foundation\\Http\\Middleware\\CheckForMaintenanceMode->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#42 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#43 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(165): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#44 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(134): Illuminate\\Foundation\\Http\\Kernel->sendRequestThroughRouter(Object(Illuminate\\Http\\Request))\n#45 /Users/joe/Documents/www/admin/index.php(42): Illuminate\\Foundation\\Http\\Kernel->handle(Object(Illuminate\\Http\\Request))\n#46 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/resources/server.php(18): require_once(''/Users/joe/Docu...'')\n#47 {main}', '[]', '2023-07-03 15:09:18', '2023-07-03 15:09:18'),
(7, 'error', 'SystemException: 模型 Cadon\\Stunring\\Models\\AdvertisementItem 必须定义一个返回 ''advertisement_id'' 表单字段选项的方法 getAdvertisementIdOptions()。 in /Users/joe/Documents/www/admin/modules/backend/classes/FormField.php:525\nStack trace:\n#0 /Users/joe/Documents/www/admin/modules/backend/classes/FormField.php(458): Backend\\Classes\\FormField->getOptionsFromModelAsDefault(Object(Cadon\\Stunring\\Models\\AdvertisementItem), Object(Cadon\\Stunring\\Models\\AdvertisementItem))\n#1 /Users/joe/Documents/www/admin/modules/backend/widgets/form/FieldProcessor.php(147): Backend\\Classes\\FormField->getOptionsFromModel(Object(Cadon\\Stunring\\Models\\AdvertisementItem), NULL, Object(Cadon\\Stunring\\Models\\AdvertisementItem))\n#2 /Users/joe/Documents/www/admin/vendor/october/rain/src/Element/Form/FieldDefinition.php(126): Backend\\Widgets\\Form->Backend\\Widgets\\Form\\{closure}()\n#3 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field_dropdown.php(2): October\\Rain\\Element\\Form\\FieldDefinition->options()\n#4 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#5 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#6 /Users/joe/Documents/www/admin/modules/backend/widgets/Form.php(299): Backend\\Classes\\WidgetBase->makePartial(''_field_dropdown'', Array)\n#7 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field.php(25): Backend\\Widgets\\Form->renderFieldElement(Object(Backend\\Classes\\FormField))\n#8 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#9 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#10 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field-container.php(9): Backend\\Classes\\WidgetBase->makePartial(''_field'', Array)\n#11 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#12 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#13 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form_fields.php(11): Backend\\Classes\\WidgetBase->makePartial(''_field-containe...'', Array)\n#14 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#15 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#16 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_section.php(16): Backend\\Classes\\WidgetBase->makePartial(''_form_fields'', Array)\n#17 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#18 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#19 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form.php(3): Backend\\Classes\\WidgetBase->makePartial(''_section'', Array)\n#20 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#21 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#22 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form-container.php(8): Backend\\Classes\\WidgetBase->makePartial(''_form'')\n#23 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#24 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#25 /Users/joe/Documents/www/admin/modules/backend/widgets/Form.php(227): Backend\\Classes\\WidgetBase->makePartial(''_form-container'', Array)\n#26 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/partials/_manage_form.php(22): Backend\\Widgets\\Form->render(Array)\n#27 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#28 /Users/joe/Documents/www/admin/modules/backend/classes/ControllerBehavior.php(134): Backend\\Classes\\Controller->makeFileContents(''/Users/joe/Docu...'', Array)\n#29 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\ControllerBehavior->makeFileContents(''/Users/joe/Docu...'', Array)\n#30 /Users/joe/Documents/www/admin/modules/backend/behaviors/RelationController.php(492): Backend\\Classes\\ControllerBehavior->makePartial(''_manage_form'', Array)\n#31 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/HasManageMode.php(233): Backend\\Behaviors\\RelationController->relationMakePartial(''manage_form'')\n#32 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/HasViewMode.php(338): Backend\\Behaviors\\RelationController->onRelationManageForm()\n#33 [internal function]: Backend\\Behaviors\\RelationController->onRelationClickViewList(''1'')\n#34 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/ExtendableTrait.php(506): call_user_func_array(Array, Array)\n#35 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/Extendable.php(46): October\\Rain\\Extension\\Extendable->extendableCall(''onRelationClick...'', Array)\n#36 /Users/joe/Documents/www/admin/modules/system/traits/DependencyMaker.php(29): October\\Rain\\Extension\\Extendable->__call(''onRelationClick...'', Array)\n#37 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(604): Backend\\Classes\\Controller->makeCallMethod(Object(Cadon\\Stunring\\Controllers\\Advertisement), ''onRelationClick...'', Array)\n#38 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(448): Backend\\Classes\\Controller->runAjaxHandler(''onRelationClick...'')\n#39 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(256): Backend\\Classes\\Controller->execAjaxHandlers()\n#40 /Users/joe/Documents/www/admin/modules/backend/classes/BackendController.php(118): Backend\\Classes\\Controller->run(''update'', Array)\n#41 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Controller.php(54): Backend\\Classes\\BackendController->run(''cadon/stunring/...'')\n#42 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/ControllerDispatcher.php(43): Illuminate\\Routing\\Controller->callAction(''run'', Array)\n#43 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(259): Illuminate\\Routing\\ControllerDispatcher->dispatch(Object(Illuminate\\Routing\\Route), Object(Backend\\Classes\\BackendController), ''run'')\n#44 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(205): Illuminate\\Routing\\Route->runController()\n#45 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(798): Illuminate\\Routing\\Route->run()\n#46 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Routing\\Router->Illuminate\\Routing\\{closure}(Object(Illuminate\\Http\\Request))\n#47 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Middleware/SubstituteBindings.php(50): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#48 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Routing\\Middleware\\SubstituteBindings->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#49 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/View/Middleware/ShareErrorsFromSession.php(49): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#50 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\View\\Middleware\\ShareErrorsFromSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#51 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(121): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#52 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(64): Illuminate\\Session\\Middleware\\StartSession->handleStatefulRequest(Object(Illuminate\\Http\\Request), Object(Illuminate\\Session\\Store), Object(Closure))\n#53 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Session\\Middleware\\StartSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#54 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/AddQueuedCookiesToResponse.php(37): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#55 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\AddQueuedCookiesToResponse->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#56 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/EncryptCookies.php(67): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#57 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\EncryptCookies->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#58 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#59 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(797): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#60 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(776): Illuminate\\Routing\\Router->runRouteWithinStack(Object(Illuminate\\Routing\\Route), Object(Illuminate\\Http\\Request))\n#61 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(740): Illuminate\\Routing\\Router->runRoute(Object(Illuminate\\Http\\Request), Object(Illuminate\\Routing\\Route))\n#62 /Users/joe/Documents/www/admin/vendor/october/rain/src/Router/CoreRouter.php(32): Illuminate\\Routing\\Router->dispatchToRoute(Object(Illuminate\\Http\\Request))\n#63 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(190): October\\Rain\\Router\\CoreRouter->dispatch(Object(Illuminate\\Http\\Request))\n#64 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Foundation\\Http\\Kernel->Illuminate\\Foundation\\Http\\{closure}(Object(Illuminate\\Http\\Request))\n#65 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Middleware/PreventRequestsDuringMaintenance.php(86): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#66 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/Http/Middleware/CheckForMaintenanceMode.php(23): Illuminate\\Foundation\\Http\\Middleware\\PreventRequestsDuringMaintenance->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#67 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): October\\Rain\\Foundation\\Http\\Middleware\\CheckForMaintenanceMode->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#68 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#69 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(165): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#70 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(134): Illuminate\\Foundation\\Http\\Kernel->sendRequestThroughRouter(Object(Illuminate\\Http\\Request))\n#71 /Users/joe/Documents/www/admin/index.php(42): Illuminate\\Foundation\\Http\\Kernel->handle(Object(Illuminate\\Http\\Request))\n#72 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/resources/server.php(18): require_once(''/Users/joe/Docu...'')\n#73 {main}', '[]', '2023-07-03 15:54:14', '2023-07-03 15:54:14'),
(8, 'error', 'SystemException: 模型 Cadon\\Stunring\\Models\\AdvertisementItem 必须定义一个返回 ''advertisement_id'' 表单字段选项的方法 getAdvertisementIdOptions()。 in /Users/joe/Documents/www/admin/modules/backend/classes/FormField.php:525\nStack trace:\n#0 /Users/joe/Documents/www/admin/modules/backend/classes/FormField.php(458): Backend\\Classes\\FormField->getOptionsFromModelAsDefault(Object(Cadon\\Stunring\\Models\\AdvertisementItem), Object(Cadon\\Stunring\\Models\\AdvertisementItem))\n#1 /Users/joe/Documents/www/admin/modules/backend/widgets/form/FieldProcessor.php(147): Backend\\Classes\\FormField->getOptionsFromModel(Object(Cadon\\Stunring\\Models\\AdvertisementItem), NULL, Object(Cadon\\Stunring\\Models\\AdvertisementItem))\n#2 /Users/joe/Documents/www/admin/vendor/october/rain/src/Element/Form/FieldDefinition.php(126): Backend\\Widgets\\Form->Backend\\Widgets\\Form\\{closure}()\n#3 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field_dropdown.php(2): October\\Rain\\Element\\Form\\FieldDefinition->options()\n#4 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#5 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#6 /Users/joe/Documents/www/admin/modules/backend/widgets/Form.php(299): Backend\\Classes\\WidgetBase->makePartial(''_field_dropdown'', Array)\n#7 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field.php(25): Backend\\Widgets\\Form->renderFieldElement(Object(Backend\\Classes\\FormField))\n#8 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#9 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#10 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field-container.php(9): Backend\\Classes\\WidgetBase->makePartial(''_field'', Array)\n#11 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#12 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#13 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form_fields.php(11): Backend\\Classes\\WidgetBase->makePartial(''_field-containe...'', Array)\n#14 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#15 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#16 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_section.php(16): Backend\\Classes\\WidgetBase->makePartial(''_form_fields'', Array)\n#17 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#18 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#19 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form.php(3): Backend\\Classes\\WidgetBase->makePartial(''_section'', Array)\n#20 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#21 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#22 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form-container.php(8): Backend\\Classes\\WidgetBase->makePartial(''_form'')\n#23 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#24 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#25 /Users/joe/Documents/www/admin/modules/backend/widgets/Form.php(227): Backend\\Classes\\WidgetBase->makePartial(''_form-container'', Array)\n#26 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/partials/_manage_form.php(69): Backend\\Widgets\\Form->render()\n#27 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#28 /Users/joe/Documents/www/admin/modules/backend/classes/ControllerBehavior.php(134): Backend\\Classes\\Controller->makeFileContents(''/Users/joe/Docu...'', Array)\n#29 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\ControllerBehavior->makeFileContents(''/Users/joe/Docu...'', Array)\n#30 /Users/joe/Documents/www/admin/modules/backend/behaviors/RelationController.php(492): Backend\\Classes\\ControllerBehavior->makePartial(''_manage_form'', Array)\n#31 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/HasManageMode.php(233): Backend\\Behaviors\\RelationController->relationMakePartial(''manage_form'')\n#32 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/HasViewMode.php(270): Backend\\Behaviors\\RelationController->onRelationManageForm()\n#33 [internal function]: Backend\\Behaviors\\RelationController->onRelationButtonCreate(''1'')\n#34 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/ExtendableTrait.php(506): call_user_func_array(Array, Array)\n#35 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/Extendable.php(46): October\\Rain\\Extension\\Extendable->extendableCall(''onRelationButto...'', Array)\n#36 /Users/joe/Documents/www/admin/modules/system/traits/DependencyMaker.php(29): October\\Rain\\Extension\\Extendable->__call(''onRelationButto...'', Array)\n#37 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(604): Backend\\Classes\\Controller->makeCallMethod(Object(Cadon\\Stunring\\Controllers\\Advertisement), ''onRelationButto...'', Array)\n#38 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(448): Backend\\Classes\\Controller->runAjaxHandler(''onRelationButto...'')\n#39 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(256): Backend\\Classes\\Controller->execAjaxHandlers()\n#40 /Users/joe/Documents/www/admin/modules/backend/classes/BackendController.php(118): Backend\\Classes\\Controller->run(''update'', Array)\n#41 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Controller.php(54): Backend\\Classes\\BackendController->run(''cadon/stunring/...'')\n#42 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/ControllerDispatcher.php(43): Illuminate\\Routing\\Controller->callAction(''run'', Array)\n#43 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(259): Illuminate\\Routing\\ControllerDispatcher->dispatch(Object(Illuminate\\Routing\\Route), Object(Backend\\Classes\\BackendController), ''run'')\n#44 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(205): Illuminate\\Routing\\Route->runController()\n#45 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(798): Illuminate\\Routing\\Route->run()\n#46 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Routing\\Router->Illuminate\\Routing\\{closure}(Object(Illuminate\\Http\\Request))\n#47 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Middleware/SubstituteBindings.php(50): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#48 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Routing\\Middleware\\SubstituteBindings->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#49 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/View/Middleware/ShareErrorsFromSession.php(49): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#50 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\View\\Middleware\\ShareErrorsFromSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#51 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(121): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#52 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(64): Illuminate\\Session\\Middleware\\StartSession->handleStatefulRequest(Object(Illuminate\\Http\\Request), Object(Illuminate\\Session\\Store), Object(Closure))\n#53 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Session\\Middleware\\StartSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#54 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/AddQueuedCookiesToResponse.php(37): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#55 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\AddQueuedCookiesToResponse->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#56 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/EncryptCookies.php(67): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#57 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\EncryptCookies->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#58 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#59 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(797): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#60 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(776): Illuminate\\Routing\\Router->runRouteWithinStack(Object(Illuminate\\Routing\\Route), Object(Illuminate\\Http\\Request))\n#61 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(740): Illuminate\\Routing\\Router->runRoute(Object(Illuminate\\Http\\Request), Object(Illuminate\\Routing\\Route))\n#62 /Users/joe/Documents/www/admin/vendor/october/rain/src/Router/CoreRouter.php(32): Illuminate\\Routing\\Router->dispatchToRoute(Object(Illuminate\\Http\\Request))\n#63 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(190): October\\Rain\\Router\\CoreRouter->dispatch(Object(Illuminate\\Http\\Request))\n#64 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Foundation\\Http\\Kernel->Illuminate\\Foundation\\Http\\{closure}(Object(Illuminate\\Http\\Request))\n#65 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Middleware/PreventRequestsDuringMaintenance.php(86): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#66 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/Http/Middleware/CheckForMaintenanceMode.php(23): Illuminate\\Foundation\\Http\\Middleware\\PreventRequestsDuringMaintenance->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#67 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): October\\Rain\\Foundation\\Http\\Middleware\\CheckForMaintenanceMode->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#68 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#69 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(165): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#70 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(134): Illuminate\\Foundation\\Http\\Kernel->sendRequestThroughRouter(Object(Illuminate\\Http\\Request))\n#71 /Users/joe/Documents/www/admin/index.php(42): Illuminate\\Foundation\\Http\\Kernel->handle(Object(Illuminate\\Http\\Request))\n#72 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/resources/server.php(18): require_once(''/Users/joe/Docu...'')\n#73 {main}', '[]', '2023-07-03 15:54:20', '2023-07-03 15:54:20'),
(9, 'error', 'SystemException: 未找到部件 ''_field_tabs''  in /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php:92\nStack trace:\n#0 /Users/joe/Documents/www/admin/modules/backend/widgets/Form.php(299): Backend\\Classes\\WidgetBase->makePartial(''_field_tabs'', Array)\n#1 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field.php(25): Backend\\Widgets\\Form->renderFieldElement(Object(Backend\\Classes\\FormField))\n#2 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#3 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#4 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field-container.php(9): Backend\\Classes\\WidgetBase->makePartial(''_field'', Array)\n#5 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#6 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#7 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form_fields.php(11): Backend\\Classes\\WidgetBase->makePartial(''_field-containe...'', Array)\n#8 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#9 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#10 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_section.php(16): Backend\\Classes\\WidgetBase->makePartial(''_form_fields'', Array)\n#11 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#12 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#13 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form.php(3): Backend\\Classes\\WidgetBase->makePartial(''_section'', Array)\n#14 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#15 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#16 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form-container.php(8): Backend\\Classes\\WidgetBase->makePartial(''_form'')\n#17 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#18 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#19 /Users/joe/Documents/www/admin/modules/backend/widgets/Form.php(227): Backend\\Classes\\WidgetBase->makePartial(''_form-container'', Array)\n#20 /Users/joe/Documents/www/admin/modules/backend/behaviors/FormController.php(430): Backend\\Widgets\\Form->render(Array)\n#21 [internal function]: Backend\\Behaviors\\FormController->formRender()\n#22 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/ExtendableTrait.php(506): call_user_func_array(Array, Array)\n#23 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/Extendable.php(46): October\\Rain\\Extension\\Extendable->extendableCall(''formRender'', Array)\n#24 /Users/joe/Documents/www/admin/plugins/cadon/stunring/controllers/product/update.php(13): October\\Rain\\Extension\\Extendable->__call(''formRender'', Array)\n#25 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#26 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(112): Backend\\Classes\\Controller->makeFileContents(''/Users/joe/Docu...'')\n#27 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(397): Backend\\Classes\\Controller->makeView(''update'')\n#28 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(265): Backend\\Classes\\Controller->execPageAction(''update'', Array)\n#29 /Users/joe/Documents/www/admin/modules/backend/classes/BackendController.php(118): Backend\\Classes\\Controller->run(''update'', Array)\n#30 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Controller.php(54): Backend\\Classes\\BackendController->run(''cadon/stunring/...'')\n#31 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/ControllerDispatcher.php(43): Illuminate\\Routing\\Controller->callAction(''run'', Array)\n#32 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(259): Illuminate\\Routing\\ControllerDispatcher->dispatch(Object(Illuminate\\Routing\\Route), Object(Backend\\Classes\\BackendController), ''run'')\n#33 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(205): Illuminate\\Routing\\Route->runController()\n#34 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(798): Illuminate\\Routing\\Route->run()\n#35 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Routing\\Router->Illuminate\\Routing\\{closure}(Object(Illuminate\\Http\\Request))\n#36 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Middleware/SubstituteBindings.php(50): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#37 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Routing\\Middleware\\SubstituteBindings->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#38 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/View/Middleware/ShareErrorsFromSession.php(49): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#39 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\View\\Middleware\\ShareErrorsFromSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#40 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(121): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#41 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(64): Illuminate\\Session\\Middleware\\StartSession->handleStatefulRequest(Object(Illuminate\\Http\\Request), Object(Illuminate\\Session\\Store), Object(Closure))\n#42 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Session\\Middleware\\StartSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#43 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/AddQueuedCookiesToResponse.php(37): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#44 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\AddQueuedCookiesToResponse->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#45 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/EncryptCookies.php(67): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#46 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\EncryptCookies->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#47 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#48 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(797): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#49 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(776): Illuminate\\Routing\\Router->runRouteWithinStack(Object(Illuminate\\Routing\\Route), Object(Illuminate\\Http\\Request))\n#50 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(740): Illuminate\\Routing\\Router->runRoute(Object(Illuminate\\Http\\Request), Object(Illuminate\\Routing\\Route))\n#51 /Users/joe/Documents/www/admin/vendor/october/rain/src/Router/CoreRouter.php(32): Illuminate\\Routing\\Router->dispatchToRoute(Object(Illuminate\\Http\\Request))\n#52 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(190): October\\Rain\\Router\\CoreRouter->dispatch(Object(Illuminate\\Http\\Request))\n#53 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Foundation\\Http\\Kernel->Illuminate\\Foundation\\Http\\{closure}(Object(Illuminate\\Http\\Request))\n#54 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Middleware/PreventRequestsDuringMaintenance.php(86): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#55 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/Http/Middleware/CheckForMaintenanceMode.php(23): Illuminate\\Foundation\\Http\\Middleware\\PreventRequestsDuringMaintenance->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#56 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): October\\Rain\\Foundation\\Http\\Middleware\\CheckForMaintenanceMode->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#57 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#58 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(165): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#59 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(134): Illuminate\\Foundation\\Http\\Kernel->sendRequestThroughRouter(Object(Illuminate\\Http\\Request))\n#60 /Users/joe/Documents/www/admin/index.php(42): Illuminate\\Foundation\\Http\\Kernel->handle(Object(Illuminate\\Http\\Request))\n#61 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/resources/server.php(18): require_once(''/Users/joe/Docu...'')\n#62 {main}', '[]', '2023-07-03 15:58:20', '2023-07-03 15:58:20'),
(10, 'error', 'SystemException: 模型 Cadon\\Stunring\\Models\\AdvertisementItem 必须定义一个返回 ''advertisement_id'' 表单字段选项的方法 getAdvertisementIdOptions()。 in /Users/joe/Documents/www/admin/modules/backend/classes/FormField.php:525\nStack trace:\n#0 /Users/joe/Documents/www/admin/modules/backend/classes/FormField.php(458): Backend\\Classes\\FormField->getOptionsFromModelAsDefault(Object(Cadon\\Stunring\\Models\\AdvertisementItem), Object(Cadon\\Stunring\\Models\\AdvertisementItem))\n#1 /Users/joe/Documents/www/admin/modules/backend/widgets/form/FieldProcessor.php(147): Backend\\Classes\\FormField->getOptionsFromModel(Object(Cadon\\Stunring\\Models\\AdvertisementItem), NULL, Object(Cadon\\Stunring\\Models\\AdvertisementItem))\n#2 /Users/joe/Documents/www/admin/vendor/october/rain/src/Element/Form/FieldDefinition.php(126): Backend\\Widgets\\Form->Backend\\Widgets\\Form\\{closure}()\n#3 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field_dropdown.php(2): October\\Rain\\Element\\Form\\FieldDefinition->options()\n#4 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#5 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#6 /Users/joe/Documents/www/admin/modules/backend/widgets/Form.php(299): Backend\\Classes\\WidgetBase->makePartial(''_field_dropdown'', Array)\n#7 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field.php(25): Backend\\Widgets\\Form->renderFieldElement(Object(Backend\\Classes\\FormField))\n#8 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#9 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#10 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field-container.php(9): Backend\\Classes\\WidgetBase->makePartial(''_field'', Array)\n#11 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#12 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#13 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form_fields.php(11): Backend\\Classes\\WidgetBase->makePartial(''_field-containe...'', Array)\n#14 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#15 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#16 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_section.php(16): Backend\\Classes\\WidgetBase->makePartial(''_form_fields'', Array)\n#17 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#18 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#19 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form.php(3): Backend\\Classes\\WidgetBase->makePartial(''_section'', Array)\n#20 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#21 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#22 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form-container.php(8): Backend\\Classes\\WidgetBase->makePartial(''_form'')\n#23 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#24 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#25 /Users/joe/Documents/www/admin/modules/backend/widgets/Form.php(227): Backend\\Classes\\WidgetBase->makePartial(''_form-container'', Array)\n#26 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/partials/_manage_form.php(69): Backend\\Widgets\\Form->render()\n#27 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#28 /Users/joe/Documents/www/admin/modules/backend/classes/ControllerBehavior.php(134): Backend\\Classes\\Controller->makeFileContents(''/Users/joe/Docu...'', Array)\n#29 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\ControllerBehavior->makeFileContents(''/Users/joe/Docu...'', Array)\n#30 /Users/joe/Documents/www/admin/modules/backend/behaviors/RelationController.php(492): Backend\\Classes\\ControllerBehavior->makePartial(''_manage_form'', Array)\n#31 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/HasManageMode.php(233): Backend\\Behaviors\\RelationController->relationMakePartial(''manage_form'')\n#32 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/HasViewMode.php(270): Backend\\Behaviors\\RelationController->onRelationManageForm()\n#33 [internal function]: Backend\\Behaviors\\RelationController->onRelationButtonCreate(''1'')\n#34 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/ExtendableTrait.php(506): call_user_func_array(Array, Array)\n#35 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/Extendable.php(46): October\\Rain\\Extension\\Extendable->extendableCall(''onRelationButto...'', Array)\n#36 /Users/joe/Documents/www/admin/modules/system/traits/DependencyMaker.php(29): October\\Rain\\Extension\\Extendable->__call(''onRelationButto...'', Array)\n#37 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(604): Backend\\Classes\\Controller->makeCallMethod(Object(Cadon\\Stunring\\Controllers\\Advertisement), ''onRelationButto...'', Array)\n#38 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(448): Backend\\Classes\\Controller->runAjaxHandler(''onRelationButto...'')\n#39 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(256): Backend\\Classes\\Controller->execAjaxHandlers()\n#40 /Users/joe/Documents/www/admin/modules/backend/classes/BackendController.php(118): Backend\\Classes\\Controller->run(''update'', Array)\n#41 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Controller.php(54): Backend\\Classes\\BackendController->run(''cadon/stunring/...'')\n#42 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/ControllerDispatcher.php(43): Illuminate\\Routing\\Controller->callAction(''run'', Array)\n#43 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(259): Illuminate\\Routing\\ControllerDispatcher->dispatch(Object(Illuminate\\Routing\\Route), Object(Backend\\Classes\\BackendController), ''run'')\n#44 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(205): Illuminate\\Routing\\Route->runController()\n#45 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(798): Illuminate\\Routing\\Route->run()\n#46 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Routing\\Router->Illuminate\\Routing\\{closure}(Object(Illuminate\\Http\\Request))\n#47 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Middleware/SubstituteBindings.php(50): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#48 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Routing\\Middleware\\SubstituteBindings->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#49 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/View/Middleware/ShareErrorsFromSession.php(49): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#50 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\View\\Middleware\\ShareErrorsFromSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#51 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(121): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#52 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(64): Illuminate\\Session\\Middleware\\StartSession->handleStatefulRequest(Object(Illuminate\\Http\\Request), Object(Illuminate\\Session\\Store), Object(Closure))\n#53 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Session\\Middleware\\StartSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#54 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/AddQueuedCookiesToResponse.php(37): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#55 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\AddQueuedCookiesToResponse->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#56 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/EncryptCookies.php(67): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#57 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\EncryptCookies->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#58 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#59 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(797): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#60 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(776): Illuminate\\Routing\\Router->runRouteWithinStack(Object(Illuminate\\Routing\\Route), Object(Illuminate\\Http\\Request))\n#61 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(740): Illuminate\\Routing\\Router->runRoute(Object(Illuminate\\Http\\Request), Object(Illuminate\\Routing\\Route))\n#62 /Users/joe/Documents/www/admin/vendor/october/rain/src/Router/CoreRouter.php(32): Illuminate\\Routing\\Router->dispatchToRoute(Object(Illuminate\\Http\\Request))\n#63 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(190): October\\Rain\\Router\\CoreRouter->dispatch(Object(Illuminate\\Http\\Request))\n#64 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Foundation\\Http\\Kernel->Illuminate\\Foundation\\Http\\{closure}(Object(Illuminate\\Http\\Request))\n#65 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Middleware/PreventRequestsDuringMaintenance.php(86): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#66 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/Http/Middleware/CheckForMaintenanceMode.php(23): Illuminate\\Foundation\\Http\\Middleware\\PreventRequestsDuringMaintenance->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#67 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): October\\Rain\\Foundation\\Http\\Middleware\\CheckForMaintenanceMode->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#68 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#69 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(165): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#70 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(134): Illuminate\\Foundation\\Http\\Kernel->sendRequestThroughRouter(Object(Illuminate\\Http\\Request))\n#71 /Users/joe/Documents/www/admin/index.php(42): Illuminate\\Foundation\\Http\\Kernel->handle(Object(Illuminate\\Http\\Request))\n#72 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/resources/server.php(18): require_once(''/Users/joe/Docu...'')\n#73 {main}', '[]', '2023-07-03 16:24:11', '2023-07-03 16:24:11'),
(11, 'error', 'SystemException: 模型 Cadon\\Stunring\\Models\\AdvertisementItem 必须定义一个返回 ''advertisement_id'' 表单字段选项的方法 getAdvertisementIdOptions()。 in /Users/joe/Documents/www/admin/modules/backend/classes/FormField.php:525\nStack trace:\n#0 /Users/joe/Documents/www/admin/modules/backend/classes/FormField.php(458): Backend\\Classes\\FormField->getOptionsFromModelAsDefault(Object(Cadon\\Stunring\\Models\\AdvertisementItem), Object(Cadon\\Stunring\\Models\\AdvertisementItem))\n#1 /Users/joe/Documents/www/admin/modules/backend/widgets/form/FieldProcessor.php(147): Backend\\Classes\\FormField->getOptionsFromModel(Object(Cadon\\Stunring\\Models\\AdvertisementItem), NULL, Object(Cadon\\Stunring\\Models\\AdvertisementItem))\n#2 /Users/joe/Documents/www/admin/vendor/october/rain/src/Element/Form/FieldDefinition.php(126): Backend\\Widgets\\Form->Backend\\Widgets\\Form\\{closure}()\n#3 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field_dropdown.php(2): October\\Rain\\Element\\Form\\FieldDefinition->options()\n#4 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#5 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#6 /Users/joe/Documents/www/admin/modules/backend/widgets/Form.php(299): Backend\\Classes\\WidgetBase->makePartial(''_field_dropdown'', Array)\n#7 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field.php(25): Backend\\Widgets\\Form->renderFieldElement(Object(Backend\\Classes\\FormField))\n#8 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#9 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#10 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field-container.php(9): Backend\\Classes\\WidgetBase->makePartial(''_field'', Array)\n#11 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#12 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#13 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form_fields.php(11): Backend\\Classes\\WidgetBase->makePartial(''_field-containe...'', Array)\n#14 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#15 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#16 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_section.php(16): Backend\\Classes\\WidgetBase->makePartial(''_form_fields'', Array)\n#17 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#18 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#19 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form.php(3): Backend\\Classes\\WidgetBase->makePartial(''_section'', Array)\n#20 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#21 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#22 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form-container.php(8): Backend\\Classes\\WidgetBase->makePartial(''_form'')\n#23 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#24 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#25 /Users/joe/Documents/www/admin/modules/backend/widgets/Form.php(227): Backend\\Classes\\WidgetBase->makePartial(''_form-container'', Array)\n#26 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/partials/_manage_form.php(22): Backend\\Widgets\\Form->render(Array)\n#27 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#28 /Users/joe/Documents/www/admin/modules/backend/classes/ControllerBehavior.php(134): Backend\\Classes\\Controller->makeFileContents(''/Users/joe/Docu...'', Array)\n#29 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\ControllerBehavior->makeFileContents(''/Users/joe/Docu...'', Array)\n#30 /Users/joe/Documents/www/admin/modules/backend/behaviors/RelationController.php(492): Backend\\Classes\\ControllerBehavior->makePartial(''_manage_form'', Array)\n#31 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/HasManageMode.php(233): Backend\\Behaviors\\RelationController->relationMakePartial(''manage_form'')\n#32 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/HasViewMode.php(338): Backend\\Behaviors\\RelationController->onRelationManageForm()\n#33 [internal function]: Backend\\Behaviors\\RelationController->onRelationClickViewList(''1'')\n#34 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/ExtendableTrait.php(506): call_user_func_array(Array, Array)\n#35 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/Extendable.php(46): October\\Rain\\Extension\\Extendable->extendableCall(''onRelationClick...'', Array)\n#36 /Users/joe/Documents/www/admin/modules/system/traits/DependencyMaker.php(29): October\\Rain\\Extension\\Extendable->__call(''onRelationClick...'', Array)\n#37 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(604): Backend\\Classes\\Controller->makeCallMethod(Object(Cadon\\Stunring\\Controllers\\Advertisement), ''onRelationClick...'', Array)\n#38 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(448): Backend\\Classes\\Controller->runAjaxHandler(''onRelationClick...'')\n#39 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(256): Backend\\Classes\\Controller->execAjaxHandlers()\n#40 /Users/joe/Documents/www/admin/modules/backend/classes/BackendController.php(118): Backend\\Classes\\Controller->run(''update'', Array)\n#41 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Controller.php(54): Backend\\Classes\\BackendController->run(''cadon/stunring/...'')\n#42 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/ControllerDispatcher.php(43): Illuminate\\Routing\\Controller->callAction(''run'', Array)\n#43 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(259): Illuminate\\Routing\\ControllerDispatcher->dispatch(Object(Illuminate\\Routing\\Route), Object(Backend\\Classes\\BackendController), ''run'')\n#44 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(205): Illuminate\\Routing\\Route->runController()\n#45 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(798): Illuminate\\Routing\\Route->run()\n#46 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Routing\\Router->Illuminate\\Routing\\{closure}(Object(Illuminate\\Http\\Request))\n#47 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Middleware/SubstituteBindings.php(50): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#48 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Routing\\Middleware\\SubstituteBindings->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#49 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/View/Middleware/ShareErrorsFromSession.php(49): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#50 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\View\\Middleware\\ShareErrorsFromSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#51 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(121): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#52 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(64): Illuminate\\Session\\Middleware\\StartSession->handleStatefulRequest(Object(Illuminate\\Http\\Request), Object(Illuminate\\Session\\Store), Object(Closure))\n#53 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Session\\Middleware\\StartSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#54 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/AddQueuedCookiesToResponse.php(37): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#55 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\AddQueuedCookiesToResponse->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#56 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/EncryptCookies.php(67): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#57 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\EncryptCookies->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#58 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#59 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(797): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#60 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(776): Illuminate\\Routing\\Router->runRouteWithinStack(Object(Illuminate\\Routing\\Route), Object(Illuminate\\Http\\Request))\n#61 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(740): Illuminate\\Routing\\Router->runRoute(Object(Illuminate\\Http\\Request), Object(Illuminate\\Routing\\Route))\n#62 /Users/joe/Documents/www/admin/vendor/october/rain/src/Router/CoreRouter.php(32): Illuminate\\Routing\\Router->dispatchToRoute(Object(Illuminate\\Http\\Request))\n#63 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(190): October\\Rain\\Router\\CoreRouter->dispatch(Object(Illuminate\\Http\\Request))\n#64 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Foundation\\Http\\Kernel->Illuminate\\Foundation\\Http\\{closure}(Object(Illuminate\\Http\\Request))\n#65 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Middleware/PreventRequestsDuringMaintenance.php(86): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#66 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/Http/Middleware/CheckForMaintenanceMode.php(23): Illuminate\\Foundation\\Http\\Middleware\\PreventRequestsDuringMaintenance->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#67 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): October\\Rain\\Foundation\\Http\\Middleware\\CheckForMaintenanceMode->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#68 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#69 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(165): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#70 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(134): Illuminate\\Foundation\\Http\\Kernel->sendRequestThroughRouter(Object(Illuminate\\Http\\Request))\n#71 /Users/joe/Documents/www/admin/index.php(42): Illuminate\\Foundation\\Http\\Kernel->handle(Object(Illuminate\\Http\\Request))\n#72 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/resources/server.php(18): require_once(''/Users/joe/Docu...'')\n#73 {main}', '[]', '2023-07-03 16:25:52', '2023-07-03 16:25:52'),
(12, 'error', 'SystemException: 未找到部件 ''_field_datetime''  in /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php:92\nStack trace:\n#0 /Users/joe/Documents/www/admin/modules/backend/widgets/Form.php(299): Backend\\Classes\\WidgetBase->makePartial(''_field_datetime'', Array)\n#1 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field.php(25): Backend\\Widgets\\Form->renderFieldElement(Object(Backend\\Classes\\FormField))\n#2 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#3 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#4 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field-container.php(9): Backend\\Classes\\WidgetBase->makePartial(''_field'', Array)\n#5 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#6 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#7 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form_fields.php(11): Backend\\Classes\\WidgetBase->makePartial(''_field-containe...'', Array)\n#8 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#9 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#10 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_section.php(16): Backend\\Classes\\WidgetBase->makePartial(''_form_fields'', Array)\n#11 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#12 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#13 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form.php(3): Backend\\Classes\\WidgetBase->makePartial(''_section'', Array)\n#14 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#15 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#16 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form-container.php(8): Backend\\Classes\\WidgetBase->makePartial(''_form'')\n#17 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#18 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#19 /Users/joe/Documents/www/admin/modules/backend/widgets/Form.php(227): Backend\\Classes\\WidgetBase->makePartial(''_form-container'', Array)\n#20 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/partials/_manage_form.php(22): Backend\\Widgets\\Form->render(Array)\n#21 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#22 /Users/joe/Documents/www/admin/modules/backend/classes/ControllerBehavior.php(134): Backend\\Classes\\Controller->makeFileContents(''/Users/joe/Docu...'', Array)\n#23 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\ControllerBehavior->makeFileContents(''/Users/joe/Docu...'', Array)\n#24 /Users/joe/Documents/www/admin/modules/backend/behaviors/RelationController.php(492): Backend\\Classes\\ControllerBehavior->makePartial(''_manage_form'', Array)\n#25 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/HasManageMode.php(233): Backend\\Behaviors\\RelationController->relationMakePartial(''manage_form'')\n#26 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/HasViewMode.php(338): Backend\\Behaviors\\RelationController->onRelationManageForm()\n#27 [internal function]: Backend\\Behaviors\\RelationController->onRelationClickViewList(''1'')\n#28 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/ExtendableTrait.php(506): call_user_func_array(Array, Array)\n#29 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/Extendable.php(46): October\\Rain\\Extension\\Extendable->extendableCall(''onRelationClick...'', Array)\n#30 /Users/joe/Documents/www/admin/modules/system/traits/DependencyMaker.php(29): October\\Rain\\Extension\\Extendable->__call(''onRelationClick...'', Array)\n#31 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(604): Backend\\Classes\\Controller->makeCallMethod(Object(Cadon\\Stunring\\Controllers\\Advertisement), ''onRelationClick...'', Array)\n#32 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(448): Backend\\Classes\\Controller->runAjaxHandler(''onRelationClick...'')\n#33 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(256): Backend\\Classes\\Controller->execAjaxHandlers()\n#34 /Users/joe/Documents/www/admin/modules/backend/classes/BackendController.php(118): Backend\\Classes\\Controller->run(''update'', Array)\n#35 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Controller.php(54): Backend\\Classes\\BackendController->run(''cadon/stunring/...'')\n#36 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/ControllerDispatcher.php(43): Illuminate\\Routing\\Controller->callAction(''run'', Array)\n#37 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(259): Illuminate\\Routing\\ControllerDispatcher->dispatch(Object(Illuminate\\Routing\\Route), Object(Backend\\Classes\\BackendController), ''run'')\n#38 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(205): Illuminate\\Routing\\Route->runController()\n#39 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(798): Illuminate\\Routing\\Route->run()\n#40 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Routing\\Router->Illuminate\\Routing\\{closure}(Object(Illuminate\\Http\\Request))\n#41 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Middleware/SubstituteBindings.php(50): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#42 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Routing\\Middleware\\SubstituteBindings->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#43 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/View/Middleware/ShareErrorsFromSession.php(49): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#44 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\View\\Middleware\\ShareErrorsFromSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#45 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(121): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#46 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(64): Illuminate\\Session\\Middleware\\StartSession->handleStatefulRequest(Object(Illuminate\\Http\\Request), Object(Illuminate\\Session\\Store), Object(Closure))\n#47 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Session\\Middleware\\StartSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#48 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/AddQueuedCookiesToResponse.php(37): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#49 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\AddQueuedCookiesToResponse->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#50 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/EncryptCookies.php(67): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#51 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\EncryptCookies->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#52 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#53 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(797): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#54 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(776): Illuminate\\Routing\\Router->runRouteWithinStack(Object(Illuminate\\Routing\\Route), Object(Illuminate\\Http\\Request))\n#55 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(740): Illuminate\\Routing\\Router->runRoute(Object(Illuminate\\Http\\Request), Object(Illuminate\\Routing\\Route))\n#56 /Users/joe/Documents/www/admin/vendor/october/rain/src/Router/CoreRouter.php(32): Illuminate\\Routing\\Router->dispatchToRoute(Object(Illuminate\\Http\\Request))\n#57 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(190): October\\Rain\\Router\\CoreRouter->dispatch(Object(Illuminate\\Http\\Request))\n#58 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Foundation\\Http\\Kernel->Illuminate\\Foundation\\Http\\{closure}(Object(Illuminate\\Http\\Request))\n#59 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Middleware/PreventRequestsDuringMaintenance.php(86): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#60 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/Http/Middleware/CheckForMaintenanceMode.php(23): Illuminate\\Foundation\\Http\\Middleware\\PreventRequestsDuringMaintenance->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#61 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): October\\Rain\\Foundation\\Http\\Middleware\\CheckForMaintenanceMode->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#62 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#63 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(165): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#64 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(134): Illuminate\\Foundation\\Http\\Kernel->sendRequestThroughRouter(Object(Illuminate\\Http\\Request))\n#65 /Users/joe/Documents/www/admin/index.php(42): Illuminate\\Foundation\\Http\\Kernel->handle(Object(Illuminate\\Http\\Request))\n#66 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/resources/server.php(18): require_once(''/Users/joe/Docu...'')\n#67 {main}', '[]', '2023-07-03 16:27:14', '2023-07-03 16:27:14'),
(13, 'error', 'SystemException: 未找到部件 ''_field_datetime''  in /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php:92\nStack trace:\n#0 /Users/joe/Documents/www/admin/modules/backend/widgets/Form.php(299): Backend\\Classes\\WidgetBase->makePartial(''_field_datetime'', Array)\n#1 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field.php(25): Backend\\Widgets\\Form->renderFieldElement(Object(Backend\\Classes\\FormField))\n#2 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#3 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#4 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_field-container.php(9): Backend\\Classes\\WidgetBase->makePartial(''_field'', Array)\n#5 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#6 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#7 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form_fields.php(11): Backend\\Classes\\WidgetBase->makePartial(''_field-containe...'', Array)\n#8 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#9 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#10 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_section.php(16): Backend\\Classes\\WidgetBase->makePartial(''_form_fields'', Array)\n#11 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#12 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#13 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form.php(3): Backend\\Classes\\WidgetBase->makePartial(''_section'', Array)\n#14 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#15 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#16 /Users/joe/Documents/www/admin/modules/backend/widgets/form/partials/_form-container.php(8): Backend\\Classes\\WidgetBase->makePartial(''_form'')\n#17 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#18 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\WidgetBase->makeFileContents(''/Users/joe/Docu...'', Array)\n#19 /Users/joe/Documents/www/admin/modules/backend/widgets/Form.php(227): Backend\\Classes\\WidgetBase->makePartial(''_form-container'', Array)\n#20 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/partials/_manage_form.php(69): Backend\\Widgets\\Form->render()\n#21 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(263): include(''/Users/joe/Docu...'')\n#22 /Users/joe/Documents/www/admin/modules/backend/classes/ControllerBehavior.php(134): Backend\\Classes\\Controller->makeFileContents(''/Users/joe/Docu...'', Array)\n#23 /Users/joe/Documents/www/admin/modules/system/traits/ViewMaker.php(98): Backend\\Classes\\ControllerBehavior->makeFileContents(''/Users/joe/Docu...'', Array)\n#24 /Users/joe/Documents/www/admin/modules/backend/behaviors/RelationController.php(492): Backend\\Classes\\ControllerBehavior->makePartial(''_manage_form'', Array)\n#25 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/HasManageMode.php(233): Backend\\Behaviors\\RelationController->relationMakePartial(''manage_form'')\n#26 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/HasViewMode.php(270): Backend\\Behaviors\\RelationController->onRelationManageForm()\n#27 [internal function]: Backend\\Behaviors\\RelationController->onRelationButtonCreate(''1'')\n#28 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/ExtendableTrait.php(506): call_user_func_array(Array, Array)\n#29 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/Extendable.php(46): October\\Rain\\Extension\\Extendable->extendableCall(''onRelationButto...'', Array)\n#30 /Users/joe/Documents/www/admin/modules/system/traits/DependencyMaker.php(29): October\\Rain\\Extension\\Extendable->__call(''onRelationButto...'', Array)\n#31 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(604): Backend\\Classes\\Controller->makeCallMethod(Object(Cadon\\Stunring\\Controllers\\Advertisement), ''onRelationButto...'', Array)\n#32 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(448): Backend\\Classes\\Controller->runAjaxHandler(''onRelationButto...'')\n#33 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(256): Backend\\Classes\\Controller->execAjaxHandlers()\n#34 /Users/joe/Documents/www/admin/modules/backend/classes/BackendController.php(118): Backend\\Classes\\Controller->run(''update'', Array)\n#35 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Controller.php(54): Backend\\Classes\\BackendController->run(''cadon/stunring/...'')\n#36 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/ControllerDispatcher.php(43): Illuminate\\Routing\\Controller->callAction(''run'', Array)\n#37 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(259): Illuminate\\Routing\\ControllerDispatcher->dispatch(Object(Illuminate\\Routing\\Route), Object(Backend\\Classes\\BackendController), ''run'')\n#38 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(205): Illuminate\\Routing\\Route->runController()\n#39 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(798): Illuminate\\Routing\\Route->run()\n#40 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Routing\\Router->Illuminate\\Routing\\{closure}(Object(Illuminate\\Http\\Request))\n#41 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Middleware/SubstituteBindings.php(50): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#42 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Routing\\Middleware\\SubstituteBindings->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#43 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/View/Middleware/ShareErrorsFromSession.php(49): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#44 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\View\\Middleware\\ShareErrorsFromSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#45 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(121): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#46 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(64): Illuminate\\Session\\Middleware\\StartSession->handleStatefulRequest(Object(Illuminate\\Http\\Request), Object(Illuminate\\Session\\Store), Object(Closure))\n#47 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Session\\Middleware\\StartSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#48 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/AddQueuedCookiesToResponse.php(37): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#49 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\AddQueuedCookiesToResponse->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#50 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/EncryptCookies.php(67): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#51 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\EncryptCookies->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#52 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#53 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(797): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#54 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(776): Illuminate\\Routing\\Router->runRouteWithinStack(Object(Illuminate\\Routing\\Route), Object(Illuminate\\Http\\Request))\n#55 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(740): Illuminate\\Routing\\Router->runRoute(Object(Illuminate\\Http\\Request), Object(Illuminate\\Routing\\Route))\n#56 /Users/joe/Documents/www/admin/vendor/october/rain/src/Router/CoreRouter.php(32): Illuminate\\Routing\\Router->dispatchToRoute(Object(Illuminate\\Http\\Request))\n#57 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(190): October\\Rain\\Router\\CoreRouter->dispatch(Object(Illuminate\\Http\\Request))\n#58 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Foundation\\Http\\Kernel->Illuminate\\Foundation\\Http\\{closure}(Object(Illuminate\\Http\\Request))\n#59 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Middleware/PreventRequestsDuringMaintenance.php(86): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#60 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/Http/Middleware/CheckForMaintenanceMode.php(23): Illuminate\\Foundation\\Http\\Middleware\\PreventRequestsDuringMaintenance->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#61 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): October\\Rain\\Foundation\\Http\\Middleware\\CheckForMaintenanceMode->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#62 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#63 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(165): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#64 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(134): Illuminate\\Foundation\\Http\\Kernel->sendRequestThroughRouter(Object(Illuminate\\Http\\Request))\n#65 /Users/joe/Documents/www/admin/index.php(42): Illuminate\\Foundation\\Http\\Kernel->handle(Object(Illuminate\\Http\\Request))\n#66 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/resources/server.php(18): require_once(''/Users/joe/Docu...'')\n#67 {main}', '[]', '2023-07-03 16:27:18', '2023-07-03 16:27:18'),
(14, 'error', 'Exception: Unexpected type of array when attempting to save attribute "advertisement_images", try adding it to the $jsonable property. in /Users/joe/Documents/www/admin/vendor/october/rain/src/Database/Model.php:395\nStack trace:\n#0 /Users/joe/Documents/www/admin/vendor/october/rain/src/Database/Model.php(444): October\\Rain\\Database\\Model->saveInternal(Array)\n#1 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/HasManageMode.php(288): October\\Rain\\Database\\Model->save(NULL, ''uB2OlwijUBM2eMe...'')\n#2 [internal function]: Backend\\Behaviors\\RelationController->onRelationManageUpdate(''1'')\n#3 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/ExtendableTrait.php(506): call_user_func_array(Array, Array)\n#4 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/Extendable.php(46): October\\Rain\\Extension\\Extendable->extendableCall(''onRelationManag...'', Array)\n#5 /Users/joe/Documents/www/admin/modules/system/traits/DependencyMaker.php(29): October\\Rain\\Extension\\Extendable->__call(''onRelationManag...'', Array)\n#6 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(604): Backend\\Classes\\Controller->makeCallMethod(Object(Cadon\\Stunring\\Controllers\\Advertisement), ''onRelationManag...'', Array)\n#7 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(448): Backend\\Classes\\Controller->runAjaxHandler(''onRelationManag...'')\n#8 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(256): Backend\\Classes\\Controller->execAjaxHandlers()\n#9 /Users/joe/Documents/www/admin/modules/backend/classes/BackendController.php(118): Backend\\Classes\\Controller->run(''update'', Array)\n#10 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Controller.php(54): Backend\\Classes\\BackendController->run(''cadon/stunring/...'')\n#11 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/ControllerDispatcher.php(43): Illuminate\\Routing\\Controller->callAction(''run'', Array)\n#12 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(259): Illuminate\\Routing\\ControllerDispatcher->dispatch(Object(Illuminate\\Routing\\Route), Object(Backend\\Classes\\BackendController), ''run'')\n#13 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(205): Illuminate\\Routing\\Route->runController()\n#14 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(798): Illuminate\\Routing\\Route->run()\n#15 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Routing\\Router->Illuminate\\Routing\\{closure}(Object(Illuminate\\Http\\Request))\n#16 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Middleware/SubstituteBindings.php(50): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#17 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Routing\\Middleware\\SubstituteBindings->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#18 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/View/Middleware/ShareErrorsFromSession.php(49): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#19 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\View\\Middleware\\ShareErrorsFromSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#20 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(121): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#21 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(64): Illuminate\\Session\\Middleware\\StartSession->handleStatefulRequest(Object(Illuminate\\Http\\Request), Object(Illuminate\\Session\\Store), Object(Closure))\n#22 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Session\\Middleware\\StartSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#23 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/AddQueuedCookiesToResponse.php(37): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#24 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\AddQueuedCookiesToResponse->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#25 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/EncryptCookies.php(67): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#26 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\EncryptCookies->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#27 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#28 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(797): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#29 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(776): Illuminate\\Routing\\Router->runRouteWithinStack(Object(Illuminate\\Routing\\Route), Object(Illuminate\\Http\\Request))\n#30 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(740): Illuminate\\Routing\\Router->runRoute(Object(Illuminate\\Http\\Request), Object(Illuminate\\Routing\\Route))\n#31 /Users/joe/Documents/www/admin/vendor/october/rain/src/Router/CoreRouter.php(32): Illuminate\\Routing\\Router->dispatchToRoute(Object(Illuminate\\Http\\Request))\n#32 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(190): October\\Rain\\Router\\CoreRouter->dispatch(Object(Illuminate\\Http\\Request))\n#33 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Foundation\\Http\\Kernel->Illuminate\\Foundation\\Http\\{closure}(Object(Illuminate\\Http\\Request))\n#34 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Middleware/PreventRequestsDuringMaintenance.php(86): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#35 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/Http/Middleware/CheckForMaintenanceMode.php(23): Illuminate\\Foundation\\Http\\Middleware\\PreventRequestsDuringMaintenance->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#36 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): October\\Rain\\Foundation\\Http\\Middleware\\CheckForMaintenanceMode->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#37 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#38 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(165): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#39 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(134): Illuminate\\Foundation\\Http\\Kernel->sendRequestThroughRouter(Object(Illuminate\\Http\\Request))\n#40 /Users/joe/Documents/www/admin/index.php(42): Illuminate\\Foundation\\Http\\Kernel->handle(Object(Illuminate\\Http\\Request))\n#41 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/resources/server.php(18): require_once(''/Users/joe/Docu...'')\n#42 {main}', '[]', '2023-07-03 16:29:15', '2023-07-03 16:29:15'),
(15, 'error', 'Exception: Unexpected type of array when attempting to save attribute "advertisement_images", try adding it to the $jsonable property. in /Users/joe/Documents/www/admin/vendor/october/rain/src/Database/Model.php:395\nStack trace:\n#0 /Users/joe/Documents/www/admin/vendor/october/rain/src/Database/Model.php(444): October\\Rain\\Database\\Model->saveInternal(Array)\n#1 /Users/joe/Documents/www/admin/modules/backend/behaviors/relationcontroller/HasManageMode.php(288): October\\Rain\\Database\\Model->save(NULL, ''U441NJKIcL7Pf2A...'')\n#2 [internal function]: Backend\\Behaviors\\RelationController->onRelationManageUpdate(''1'')\n#3 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/ExtendableTrait.php(506): call_user_func_array(Array, Array)\n#4 /Users/joe/Documents/www/admin/vendor/october/rain/src/Extension/Extendable.php(46): October\\Rain\\Extension\\Extendable->extendableCall(''onRelationManag...'', Array)\n#5 /Users/joe/Documents/www/admin/modules/system/traits/DependencyMaker.php(29): October\\Rain\\Extension\\Extendable->__call(''onRelationManag...'', Array)\n#6 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(604): Backend\\Classes\\Controller->makeCallMethod(Object(Cadon\\Stunring\\Controllers\\Advertisement), ''onRelationManag...'', Array)\n#7 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(448): Backend\\Classes\\Controller->runAjaxHandler(''onRelationManag...'')\n#8 /Users/joe/Documents/www/admin/modules/backend/classes/Controller.php(256): Backend\\Classes\\Controller->execAjaxHandlers()\n#9 /Users/joe/Documents/www/admin/modules/backend/classes/BackendController.php(118): Backend\\Classes\\Controller->run(''update'', Array)\n#10 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Controller.php(54): Backend\\Classes\\BackendController->run(''cadon/stunring/...'')\n#11 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/ControllerDispatcher.php(43): Illuminate\\Routing\\Controller->callAction(''run'', Array)\n#12 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(259): Illuminate\\Routing\\ControllerDispatcher->dispatch(Object(Illuminate\\Routing\\Route), Object(Backend\\Classes\\BackendController), ''run'')\n#13 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Route.php(205): Illuminate\\Routing\\Route->runController()\n#14 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(798): Illuminate\\Routing\\Route->run()\n#15 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Routing\\Router->Illuminate\\Routing\\{closure}(Object(Illuminate\\Http\\Request))\n#16 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Middleware/SubstituteBindings.php(50): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#17 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Routing\\Middleware\\SubstituteBindings->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#18 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/View/Middleware/ShareErrorsFromSession.php(49): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#19 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\View\\Middleware\\ShareErrorsFromSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#20 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(121): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#21 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Session/Middleware/StartSession.php(64): Illuminate\\Session\\Middleware\\StartSession->handleStatefulRequest(Object(Illuminate\\Http\\Request), Object(Illuminate\\Session\\Store), Object(Closure))\n#22 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Session\\Middleware\\StartSession->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#23 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/AddQueuedCookiesToResponse.php(37): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#24 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\AddQueuedCookiesToResponse->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#25 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Cookie/Middleware/EncryptCookies.php(67): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#26 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): Illuminate\\Cookie\\Middleware\\EncryptCookies->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#27 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#28 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(797): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#29 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(776): Illuminate\\Routing\\Router->runRouteWithinStack(Object(Illuminate\\Routing\\Route), Object(Illuminate\\Http\\Request))\n#30 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Routing/Router.php(740): Illuminate\\Routing\\Router->runRoute(Object(Illuminate\\Http\\Request), Object(Illuminate\\Routing\\Route))\n#31 /Users/joe/Documents/www/admin/vendor/october/rain/src/Router/CoreRouter.php(32): Illuminate\\Routing\\Router->dispatchToRoute(Object(Illuminate\\Http\\Request))\n#32 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(190): October\\Rain\\Router\\CoreRouter->dispatch(Object(Illuminate\\Http\\Request))\n#33 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(141): Illuminate\\Foundation\\Http\\Kernel->Illuminate\\Foundation\\Http\\{closure}(Object(Illuminate\\Http\\Request))\n#34 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Middleware/PreventRequestsDuringMaintenance.php(86): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#35 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/Http/Middleware/CheckForMaintenanceMode.php(23): Illuminate\\Foundation\\Http\\Middleware\\PreventRequestsDuringMaintenance->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#36 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(180): October\\Rain\\Foundation\\Http\\Middleware\\CheckForMaintenanceMode->handle(Object(Illuminate\\Http\\Request), Object(Closure))\n#37 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Pipeline/Pipeline.php(116): Illuminate\\Pipeline\\Pipeline->Illuminate\\Pipeline\\{closure}(Object(Illuminate\\Http\\Request))\n#38 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(165): Illuminate\\Pipeline\\Pipeline->then(Object(Closure))\n#39 /Users/joe/Documents/www/admin/vendor/laravel/framework/src/Illuminate/Foundation/Http/Kernel.php(134): Illuminate\\Foundation\\Http\\Kernel->sendRequestThroughRouter(Object(Illuminate\\Http\\Request))\n#40 /Users/joe/Documents/www/admin/index.php(42): Illuminate\\Foundation\\Http\\Kernel->handle(Object(Illuminate\\Http\\Request))\n#41 /Users/joe/Documents/www/admin/vendor/october/rain/src/Foundation/resources/server.php(18): require_once(''/Users/joe/Docu...'')\n#42 {main}', '[]', '2023-07-03 16:31:47', '2023-07-03 16:31:47');
